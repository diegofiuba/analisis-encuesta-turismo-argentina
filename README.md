...
## Objetivo:
- Predecir el nivel de gasto turístico a partir de las características del viaje
- Identificar las variables con mayor impacto en el gasto de los turistas
...
El modelo obtuvo una accuracy de 87,90% en el set de prueba
